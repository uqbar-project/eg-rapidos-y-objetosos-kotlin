...
val audaz: (Int) -> FormaDeConducir = {tiempoCurva -> {
      pista-> pista.cantidadCurvas * tiempoCurva * pista.largoPorVuelta
        }
}

const val VALOR_BASE = 30
val virtuoso: (Int) -> FormaDeConducir = { nivelVirtuosismo -> { pista -> pista.largoPorVuelta * (VALOR_BASE / nivelVirtuosismo) }}
