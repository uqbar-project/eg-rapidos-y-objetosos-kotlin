...
class PilotoTest: DescribeSpec({
    describe("cuando un piloto es cabulero") {
        val pilotoCabulero: Piloto = Piloto("Juan María Traverso")
    ...
    describe("cuando un piloto es audaz") {
        val pilotoAudaz: Piloto = Piloto("José Froilán gonzalez").apply { formaConducir = audaz(2) }
    ...
    describe("cuando un piloto es vituoso") {
        val pilotoVirtuoso: Piloto = Piloto("Juan Manuel Fangio").apply { formaConducir = virtuoso(3) }
